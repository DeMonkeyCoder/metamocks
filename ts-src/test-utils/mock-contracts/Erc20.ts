...
export class Erc20MockContract
  extends MockContract<Erc20>
  implements MockContractInterface<Erc20> {
  abi = ERC20_ABI;
  allowedList: string[] = [];
...
export class Erc20MockContractAllowAll extends Erc20MockContract {
  async allowance(
    _owner: string,
    _spender: string,
    overrides: CallOverrides | undefined
