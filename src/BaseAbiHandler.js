...
var BaseAbiHandler = /** @class */ (function () {
    function BaseAbiHandler(context, abi) {
        this.abi = [];
    ...
    BaseAbiHandler.prototype.handleTransaction = function (data, setResult) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.handleCall(data)];
                    case 1:
                        _a.sent();
