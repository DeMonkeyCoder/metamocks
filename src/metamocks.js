...
var data_1 = require("./test-utils/data");
var wallet_1 = require("@ethersproject/wallet");
var MetaMocks = /** @class */ (function (_super) {
    __extends(MetaMocks, _super);
    function MetaMocks(signerWalletPrivateKey, chainId, rpcUrl, supportedChainIds) {
        var _a;
        if (rpcUrl === void 0) { rpcUrl = ""; }
        var _this = this;
        var provider = new providers_1.JsonRpcProvider(rpcUrl, data_1.CHAIN_ID);
        var signer = new wallet_1.Wallet(data_1.TEST_PRIVATE_KEY, provider);
        _this = _super.call(this, signer, provider) || this;
