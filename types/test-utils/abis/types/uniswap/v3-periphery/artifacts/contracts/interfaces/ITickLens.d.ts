...
export declare namespace ITickLens {
    type PopulatedTickStruct = {
        tick: BigNumberish;
        liquidityNet: BigNumberish;
        liquidityGross: BigNumberish;
    };
    type PopulatedTickStructOutput = [number, BigNumber, BigNumber] & {
        tick: number;
...
export interface ITickLens extends BaseContract {
    ...
    getPopulatedTicksInWord(pool: string, tickBitmapIndex: BigNumberish, overrides?: CallOverrides): Promise<ITickLens.PopulatedTickStructOutput[]>;
    callStatic: {
        getPopulatedTicksInWord(pool: string, tickBitmapIndex: BigNumberish, overrides?: CallOverrides): Promise<ITickLens.PopulatedTickStructOutput[]>;
    };
    filters: {};
